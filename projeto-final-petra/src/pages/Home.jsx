  ...
  return (
    <>
      ...
      <main className={styles.mainContent}>
        <h1 className={`${styles.Title} typing`}>
        ...
        <div className={`${styles.homeContainer} ${styles.backgroundImage}`}>
          <div className={styles.cardContainer}>
            ...
            <p className={styles.cardDescription}>
              ...
              direcionamos o usuário para políticas que se encaixam nesses
              perfis. Além disso, temos um cadastro de profissionais voluntários
          ...
          <div className={styles.cardContainer}>
            ...
            <p className={styles.cardDescription}>
              ...
              nos dados do Instituto Brasileiro de Geografia e Estátistica
              (IBGE) e do Indíce de Desenvolvimento Sustentável das Cidades
              (IDSC-BR) referentes ao município de Camaragibe-PE, que apontam
              desafios significativos na redução das desigualdades sociais na
              cidade nos últimos anos, como no percentual de pessoas abaixo da
              linha da pobreza inseridas no Cadastro Único e serviços do
              CRAS/CREAS, percebemos a necessidade urgente de proporcionar
              informações claras e acessíveis sobre a rede socioassistencial
